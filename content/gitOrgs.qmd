...
-   **Create a Team Manual.** This will serve as the primary go-to for all components of that team.
    ...
    -   Follow the [methods](https://sael-swfsc.github.io/OpenScience/content/labManual.html){target="_blank"} for creating a 'Lab Manual' for your team (a 'Team Manual'). Use the same naming structure for your team manual as your name. For example, the repository for the PAM-Glider team will be titled "PAM-Glider".
...
2.  **Create Repository.** Create your repository (see [Quickstart for repositories](https://docs.github.com/en/enterprise-cloud@latest/repositories/creating-and-managing-repositories/quickstart-for-repositories){target="_blank"}) and use a thoughtful name that includes the Prefix 'PAM' (at a minimum). Use the word 'test' in the name if the purpose of this repo is to test something out (and later delete!). Consider using a template for your repo, such as our [Research Compendium](https://sael-swfsc.github.io/OpenScience/content/researchCompendium.html){target="_blank"} or our [Lab Manual](https://sael-swfsc.github.io/OpenScience/content/labManual.html){target="_blank"} templates.
