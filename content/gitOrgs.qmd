...
***Github Organizations:*** Organizations are the 'owners' of shared repositories, discussions, and projects where these things are kept completely separate from each other. For example, NOAA Fisheries has a single nmfs-ost Github Org, and each science center has a single Github Org. Best practices suggest minimizing the number of existing Github Organizations, deferring to 'Teams' for identifying groups within an Organization.
