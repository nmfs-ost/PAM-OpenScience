...
1.  Create a new diagram by:
    ...
    2.  Save As –\> Name your diagram, save as XML (drawio) format, and save to your DEVICE and save in the appropriate folder in your Github repository. For example here is where the diagram below is saved: //documents/Github/OpenScience/output/OSworkflow.drawio
