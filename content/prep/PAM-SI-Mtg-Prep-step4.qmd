...
5.  **Modify Document *(Under Construction)***
    ...
    1.  In the lower right section of RStudio, navigate to 'Files' and 'Content'. Find and Open the 'Attendees.qmd' file in RStudio

        ![](/images/openingAttendeesDoc.png){width="536"}
    ...
    3.  Add your name in BOLD, your affiliation in Italics, with a link to your lab or personal website, insert a picture of you, and give a one sentence explanation of the work you do with NOAA Fisheries.
