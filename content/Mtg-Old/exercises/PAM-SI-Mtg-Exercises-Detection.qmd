...
4.  Create a new quarto Document
    ...
    2.  Click on ⚙️**More** dropdown, then select **Copy** and save as "**PAM-SI-Mtg-Exercises-Detection.qmd**"

5.  Modify document

    1.  At top, where it says 'Chapter Template', replace with "Acoustic Detection Software"
...
6.  Link **PAM-SI-Mtg-Exercises-Detection.qmd** to Report
    ...
    3.  In this position, write '- text/PAM-SI-Mtg-Exercises-Detection.qmd' (be sure there is only one space between the - and the word 'content')
...
7.  Commit & Push to Github
    ...
    2.  At the bottom left, describe the modifications you made to the document, and then select 'commit'. For example, you may want to write "Add Detection Section" and in details, state "Added draft summary for Detection Workshop Section".

    3.  Once the commit goes through-- select 'Push to Origin' at the top. This will push changes to your Github repository.

8.  Open associated Github Issue [**here**](https://github.com/SAEL-SWFSC/PAM-SI-Mtg-March2024/issues/27), and make sure you've completed all tasks
