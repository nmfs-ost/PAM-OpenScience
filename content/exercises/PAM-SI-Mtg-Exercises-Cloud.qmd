...
4.  Create a new quarto Document
    ...
    2.  Click on ⚙️**More** dropdown, then select **Copy** and save as "**PAM-SI-Mtg-Exercises-Cloud.qmd**"

5.  Insert Table for Tools/Software/Detectors to consider

    1.  Insert Table: In Visual Editor, select the Table dropdown menu to insert a table with 10 rows and 3 columns. Enter "List of Potential Tools/Software/Detectors to Consider for Cloud Computing' in the Caption.

    2.  Fill out the table with the preliminary list identified in the Template Workshop Report- PAM SI Workshop google document, under Cloud Computing Section (link [here](https://docs.google.com/document/d/1sv0Yk1U-63M_oGOWg4sMN2VRqc9ymg9okhcNdoAUNKk/edit?usp=sharing)). Add more rows if necessary.

6.  Modify document

    1.  At top, where it says 'Chapter Template', replace with "Cloud Computing and EDA/IT Needs"
...
7.  Link **PAM-SI-Mtg-Exercises-Cloud.qmd** to Report
    ...
    3.  In this position, write '- text/PAM-SI-Mtg-Exercises-Cloud.qmd' (be sure there is only one space between the - and the word 'content')
...
8.  Commit & Push to Github
    ...
    2.  At the bottom left, describe the modifications you made to the document, and then select 'commit'. For example, you may want to write "Add Cloud Section" and in details, state "Added draft summary for Cloud Workshop Section".

    3.  Once the commit goes through-- select 'Push to Origin' at the top. This will push changes to your Github repository.

9.  Open associated Github Issue [**here**](https://github.com/SAEL-SWFSC/PAM-SI-Mtg-March2024/issues/26), and make sure you've completed all tasks
