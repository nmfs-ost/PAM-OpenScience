...
4.  Create a new quarto Document
    ...
    2.  Click on ⚙️**More** dropdown, then select **Copy** and save as "**PAM-SI-Mtg-Exercises-Soundscape.qmd**"

5.  Insert Table for Data types and Availability

    1.  Insert Table: In Visual Editor, select the Table dropdown menu to insert a table with 5 rows and 3 columns. Enter "List of data types needed to expand sound metric research questions' in the Caption.

    2.  Add "Data type", "Additional Questions", and "Data Availability" as the three column headers.

6.  Modify document

    1.  At top, where it says 'Chapter Template', replace with "Soundscape Tools, Metrics, Analyses"
...
7.  Link **PAM-SI-Mtg-Exercises-Soundscape.qmd** to Report
    ...
    3.  In this position, write '- text/PAM-SI-Mtg-Exercises-Soundscape.qmd' (be sure there is only one space between the - and the word 'content')
...
8.  Commit & Push to Github
    ...
    2.  At the bottom left, describe the modifications you made to the document, and then select 'commit'. For example, you may want to write "Add Soundscape Section" and in details, state "Added draft summary for Soundscape Workshop Section".

    3.  Once the commit goes through-- select 'Push to Origin' at the top. This will push changes to your Github repository.

9.  Open associated Github Issue [**here**](https://github.com/SAEL-SWFSC/PAM-SI-Mtg-March2024/issues/30), and make sure you've completed all tasks
