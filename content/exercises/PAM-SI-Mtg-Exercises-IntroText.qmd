...
***Exercise:*** Insert preliminary text for the Report Introduction based on the PAM-SI Proposal. Skills include navigating the Meeting Repository (files/folders), working with Quarto visual editor to add text and an image. Practice committing changes and pushing up to Github.
...
2.  View file/folder structure and open Intro file
    ...
    7.  Link Intro.qmd to Report
        ...
        3.  In this position, write '- content/Intro.qmd' (be sure there is only one space between the - and the word 'content')
