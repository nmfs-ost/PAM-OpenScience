...
-   National Center for Environmental Information ([NCEI](https://www.ncei.noaa.gov/products/passive-acoustic-data)): raw data, metadata, soundscape data

-   Open Science Data Platforms: digital platform that allows researchers to access, share, and store research data. Examples include [Figshare](https://figshare.com/), [Zenodo](https://zenodo.org/), etc.

-   Detection Data: Specific detections relevant to a project can be saved to [PACM](https://www.fisheries.noaa.gov/resource/data/passive-acoustic-cetacean-map), [OBIS](https://obis.org/), [GBIF](https://www.gbif.org/), or other public platforms.
...
[Adrift in the California Current Research Compendium](https://github.com/SAEL-SWFSC/Adrift)

[Beaked Whale BANTER Research Compendium](https://github.com/shannonrankin/BANTER_BeakedWhales)
