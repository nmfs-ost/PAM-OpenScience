...
5.  **Modify Document *(Under Construction)***
    ...
    1.  In the lower right section of RStudio, navigate to 'Files' and open the 'Content' folder. Find and Open the 'AttendeeIntros.qmd' file in RStudio (insert Screenshot)
