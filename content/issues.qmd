...
1.  Go to the [Open Science pages](https://sael-swfsc.github.io/OpenScience/). At the top right, you will see 'On this page', and below this you'll find a github symbol and 'Edit this page'.
...
It is also possible to create custom issue forms, with dropdowns, checkboxes, etc. See Resources, below, for more information (we may build out a test example in the future), and find examples of form issues by Kourtney Burger [here](https://github.com/Kourtney-Burger/Inventree/issues) (click on 'new issue' to see forms).
...
[Creating GitHub Issue Templates- Eli Holmes](https://youtu.be/iCNA_zyawi8?feature=shared)

[Create Github Issue Forms](https://youtu.be/qQE1BUkf2-s?feature=shared)

[Example Github Issue Forms- Kourtney Burger](https://github.com/Kourtney-Burger/Inventree/issues)- Click on 'New Issue' button to see forms.

[Github Issue Template Cheat Sheet](https://gist.github.com/Elliria/ee13ed5201aaaac6f77f55290f189f0a)- Explanation and examples for creating yaml code for Custom Issue Forms.
